		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					...
					<div class="ms-auto">
						<div class="btn-group">
							<button type="button" class="btn btn-primary"><a class="text-white" href="{{route('medicine.index')}}">Purchase list</a></button>
							</div>
						</div>
					</div>
				</div>
                        ...
                        <form class="form" method="post" action="{{route('purchase.store')}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select required class="form-control form-select" name="supplier_id" id="supplier_id">
